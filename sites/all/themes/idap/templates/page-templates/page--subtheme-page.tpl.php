	...
	<div class="enclosure page">
		...
		<div id="footer">
			<div class="enclosure footer">
				<div id="footer-horizontal-band">
					<div class="left copyright">
						&copy; United Nations Development Programme 2012
					</div>
					<div class="right copyright">
						<ul class="horizontal-menu">
							<li class="first odd"><a href="#">About IDA</a></li>
							<li class="even"><a href="#">Terms & Conditions</a></li>
							<li class="odd"><a href="#">Privacy Statement</a></li>
							<li class="even"><a href="#">Sitemap</a></li>
							<li class="last odd"><a href="#">Contact Us</a></li>
							<div class="clearfix"></div>
						</ul>
					</div>
					<div class="clearfix"></div>
				</div> <!-- footer-horizontal-band -->
